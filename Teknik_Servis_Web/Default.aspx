        ...
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1>En ucuz fiyatlarla en uygun yüzlerce ürün
	<br>bir tıkla kapınızda</h1>
...
<section class="slide-wrapper" id="about">
	...
	<img src="web/images/About_Us.jpg" class="img-fluid" alt="">
	<p class="iner mt-5"> 
        ...
        <div class="container">
            <div class="wthree_pvt_title text-center">
                ...
                <p class="main_p mb-5  text-center mx-auto">
                    Mağazamızdan Almış Olduğunuz Ürünlerde Herhangi Bir Teknik Problem Oluşursa 2 yıl Süreyle Herhangi bir ücret Ödemeden
                    Tamir Ve Onarım İşlemleri Yapmaktayız.
                </p>
                <a class="btn btn-danger" href="WebForm1.aspx" role="button">Arızalı Ürün Takibi</a>
            </div>
            <div class="wthree_pvtits-services-row row">
                ...
                <div class="col-lg-4 col-md-6  wthree_sgrid  py-sm-5 py-4">
                    ...
                    <h4 class="my-3">%98 Memnuniyet</h4>
                </div>
                <div class="col-lg-4 col-md-6  wthree_sgrid   py-sm-5 py-4">
...
<!-- contact -->
	 <section class="wedo" id="contact">
		   ...
		   <p class="main_p mb-5  text-center mx-auto">
               Öneri ve Şikayetlerinizi Bize Bildirin.
		   </p>
		   <div class="contact_grid_right mt-5 mx-auto text-center">
				<form action="#" method="post" runat="server">
					<div class="row contact_top">
						...
						<asp:TextBox ID="TextBox4" runat="server" placeholder="Açıklama..." TextMode="MultiLine" Height="50"></asp:TextBox>
			...
			<div class="follow">
				...
				<p>© 2021 Teknik Servis ve Ürün Takip Sistemi | Tüm Hakları saklıdır.
